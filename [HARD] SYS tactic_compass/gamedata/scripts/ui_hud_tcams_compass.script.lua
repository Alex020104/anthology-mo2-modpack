...
if compass and compass.UIFlatCompass then
    ...
    function compass.UIFlatCompass:Refresh()
        ...
        self.compass_dialog:SetWndPos(vector2():set((cfg.compass_pos_x or 512) - cfg.compass_dialog_w / 2, cfg.compass_pos_y))
...
function on_option_change()
    local compass_pos_state  = compass_mcm and compass_mcm.get_config("tc_main/compass_sc_pos")
    local compass_pos_x      = compass_mcm and compass_mcm.get_config("tc_main/compass_pos_x")
    local compass_pos_y      = compass_mcm and compass_mcm.get_config("tc_main/compass_pos_y")
    local compass_offset_x   = tonumber(compass_pos_x) or 0
    local compass_offset_y   = tonumber(compass_pos_y) or 0

    cfg.compass_pos_x       = 512 + compass_offset_x
    cfg.compass_pos_y       = ((compass_pos_state == 1) and cfg.compass_pos_y_btm or cfg.compass_pos_y_top) + compass_offset_y
    cfg.mark_pos_y          = ((compass_pos_state == 1) and cfg.mark_pos_y_btm or cfg.mark_pos_y_top) + compass_offset_y
